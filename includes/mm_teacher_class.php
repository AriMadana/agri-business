...
// class MM_Teacher_Class extends Db_object {
//
// 	protected static $db_table = "mm_teacher";
// 	protected static $db_fields = array('t_id', 't_user', 'first_name','last_name', 't_pass', 't_ssn', 't_gender', 't_birth', 't_start', 't_sub',
// 																			't_class', 't_pno', 't_add', 't_role', 't_school', 't_head','t_active','$t_manage','t_father');
//
// 	public $t_id;
// 	public $t_user;
// 	public $first_name;
...
// 		$result = $this -> count_by_query("SELECT * FROM $db_table WHERE t_user = '$username';");
